  ...
  const enrollCourse = async () => {
    try {
      ...
      if (!courseData || !courseData._id) {
        return toast.error("Course data is not loaded properly.");
      }
  
      console.log("Making request to:", backendUrl + "/api/user/purchase");
      console.log("Sending Course ID:", courseData._id, "Type:", typeof courseData._id);
  
      const { data } = await axios.post(
        backendUrl + "/api/user/purchase",
        { courseId: courseData._id }, // Ensure courseId is sent as a string
      ...
      if (data.success) {
        ...
        if (!session_url) {
          return toast.error("Session URL is missing.");
        }
